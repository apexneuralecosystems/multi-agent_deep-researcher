...
def get_llm_client():
    ...
    # OpenRouter uses OpenAI-compatible API, so we set these env vars
    # CrewAI's LLM class will use these when base_url is provided
    os.environ["OPENAI_API_KEY"] = openrouter_api_key
    os.environ["OPENAI_API_BASE"] = "https://openrouter.ai/api/v1"

    # Initialize LLM with OpenRouter configuration
    # Using base_url makes CrewAI use the OpenAI client directly
    # OpenRouter model format is "openai/gpt-4o-mini" for GPT-4o mini
    # Can be changed via environment variable OPENROUTER_MODEL
